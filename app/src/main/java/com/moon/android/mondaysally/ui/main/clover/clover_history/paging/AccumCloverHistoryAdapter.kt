...
import com.moon.android.mondaysally.databinding.ItemAccumCloverHistoryBinding

class AccumCloverHistoryAdapter() :
    PagingDataAdapter<CloverHistory, AccumCloverHistoryAdapter.ViewHolder>(GiftDiffUtil) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding =
            DataBindingUtil.inflate<ItemAccumCloverHistoryBinding>(
                layoutInflater,
                viewType,
                parent,
                false
    ...
    override fun getItemViewType(position: Int): Int {
        return R.layout.item_accum_clover_history
    }
    ...
    inner class ViewHolder(private val binding: ItemAccumCloverHistoryBinding) :
